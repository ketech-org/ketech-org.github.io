...
- We do **not** ask for your name, email address, phone number, or other directly identifying information.
...
**None.**  
We don’t provide sign-ups, profiles, or user-to-user features, so you do not directly provide personal information to us.

### 2.2 Information collected automatically

Although we don’t collect personal info directly, the Apps and integrated services may automatically collect certain data, such as:

- **Device and app information**: device type, operating system version, language, app version, and performance diagnostics (e.g., crash logs).
- **Approximate location**: inferred from IP address (city/region-level), if enabled by an ad provider.
- **Advertising identifiers**: such as Apple’s Identifier for Advertisers (IDFA) or other device identifiers, when you grant permission.
- **Usage data**: how you interact with the Apps (e.g., screens viewed, session duration).
...
- show ads in the Apps,
- limit ad frequency,
- measure ad performance,
- detect fraud and abuse.

If an App is used by children, we aim to use child-appropriate ad settings (e.g., non-personalised or families-compliant ads where supported). Ad networks require this for child-directed audiences.
...
- **Apple processes your payment** and handles your payment information.
...
We (and our service partners) use information to:

1. **Deliver app functionality** and maintain performance.
2. **Show ads** and measure their effectiveness.
3. **Process purchases** and subscription entitlements.
4. **Prevent fraud, security issues, and abuse.**
5. **Improve the Apps** (for example, by understanding crashes or common feature usage).
...
- **Ad providers** (to serve/measure ads),
- **Apple** (for purchases and device services),
- **Analytics / crash reporting providers** (if used),
...
If you have questions about this policy or privacy in our Apps, contact:

**K&E Technology Consultants Ltd**  
Email: **info@ketech.org**
